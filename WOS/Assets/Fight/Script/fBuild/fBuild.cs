...
public class fBuild : MonoBehaviour {
    ...
    public enum eBuildName { NONE = -1, JELLY, BEAR, EL,RABBIT,GUN,DOG,SHEEP,SPACE,CLOWN};  // 건물 enum
    ...
    public fBuild(string name, string comment, eBuildName buildName, int Jelly, int aMount)
    {
        SetItem(name, comment, buildName, Jelly, aMount);
    }
    public fBuild(string name, string comment, eBuildName buildName, int Jelly)
    {
